...
import BotResultRow from "../components/Bot/BotResultRow";
    ...
    <div className="flex flex-col h-full w-full">
      ...
      <div className="p-1 h-full flex flex-col sm:flex-row sm:justify-between">
        <div className="w-full sm:w-[180%] h-full sm:mr-2 flex flex-col">
          <div className="flex border rounded-md border-gray-800 w-full h-full">
            <TradingViewWidget pair={pair} />
          </div>

          <div className="flex flex-col rounded-md w-full h-full mt-2 text-smxl">
            <BotResultRow
              pair="BTC/USDT"
              entirePrice="2054$"
              goalPrice="3100$"
        ...
        <div className="p-2 w-full flex flex-col items-center sm:ml-2 mt-2 sm:mt-0 border border-gray-800 rounded-md text-sm justify-between">
          <div className="h-auto mt-2 w-full">
            <h3 className="flex items-center border-b border-gray-500 justify-center pb-2 mb-1">
          ...
          <div className="w-full bg-gray-800 flex flex-col justify-center items-center rounded-md p-2 m-2 text-sm">
            <p className="mb-2 flex justify-center font-bold ">
              💰 Current bot balance
            </p>
            <p className=" font-bold text-emerald-300">{balanceToken} TNF</p>
          </div>

          <div className="flex w-full justify-center items-center border border-gray-800 m-1 rounded-sm">
            <div className="flex items-center justify-center w-full border-r bg-gray-600">
          ...
          <div className="flex text-smxl justify-between items-center w-[80%] border border-gray-800 rounded-md m-5 ">
            <div
          ...
          <div className="flex justify-center pb-2 w-full mt-2">
            <Button className="bg-green-600 text-white w-[80%] mx-1">
              Start trading AI
            </Button>
